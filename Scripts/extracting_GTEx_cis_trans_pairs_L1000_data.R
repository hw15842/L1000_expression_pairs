...
GTEx_cis_trans_pairs_gene_symbols <- read.csv("/Users/hw15842/Documents/PhD_work/Chapter4_L1000_MR_triplicates_analyses/L1000_expression_pairs/Data/GTEx_cis_trans_pairs_gene_symbols.csv", header=T)
